...
class Net(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        layer = nn.TransformerEncoderLayer(
            d_model=self.dim_feats + 5 * cfg.transformer_nhead,
            nhead=cfg.transformer_nhead or 16,
            dim_feedforward=(self.dim_feats + 5 * cfg.transformer_nhead) * (cfg.expansion_factor or 4),
        ...
        self.linear = nn.Linear(self.dim_feats + 5 * cfg.transformer_nhead, self.cfg.num_classes)
    ...
    def forward(self, batch, return_loss=False, return_features=False):
        ...
        z = batch["pz"]
        z = z.repeat(1, 1, self.cfg.transformer_nhead)

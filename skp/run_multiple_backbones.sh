# debug
python train.py cfg000_sagittal_t1_foramina_slice_dist_level_seq_224 --sync_batchnorm --benchmark --fold 0 --neptune_mode debug --backbone mobilenetv3_small_100 --backbone_img_size True --neptune_mode debug
...
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq_224 --sync_batchnorm --benchmark --fold 0
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq_224 --sync_batchnorm --benchmark --fold 1
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq_224 --sync_batchnorm --benchmark --fold 2
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq_224 --sync_batchnorm --benchmark --fold 3
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq_224 --sync_batchnorm --benchmark --fold 4

ts --gpus 2 python train.py cfg000_sagittal_t1_foramina_slice_dist_level_seq_224 --sync_batchnorm --benchmark --fold 0 --backbone maxvit_tiny_tf_512 --backbone_img_size True
...
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 0 --backbone maxvit_tiny_tf_512 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 1 --backbone maxvit_tiny_tf_512 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 2 --backbone maxvit_tiny_tf_512 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 3 --backbone maxvit_tiny_tf_512 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 4 --backbone maxvit_tiny_tf_512 --backbone_img_size True

ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 0 --backbone coatnet_1_rw_224 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 1 --backbone coatnet_1_rw_224 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 2 --backbone coatnet_1_rw_224 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 3 --backbone coatnet_1_rw_224 --backbone_img_size True
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 4 --backbone coatnet_1_rw_224 --backbone_img_size True

ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 0 --backbone dm_nfnet_f0.dm_in1k
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 1 --backbone dm_nfnet_f0.dm_in1k
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 2 --backbone dm_nfnet_f0.dm_in1k
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 3 --backbone dm_nfnet_f0.dm_in1k
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 4 --backbone dm_nfnet_f0.dm_in1k

ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 0 --backbone tf_efficientnetv2_m
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 1 --backbone tf_efficientnetv2_m
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 2 --backbone tf_efficientnetv2_m
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 3 --backbone tf_efficientnetv2_m
ts --gpus 2 python train.py cfg000_genv5_axial_spinal_crops_bb_bce_gt_attn_pool --sync_batchnorm --benchmark --fold 4 --backbone tf_efficientnetv2_m
...
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 0 --backbone tinynet_c --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 1 --backbone tinynet_c --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 2 --backbone tinynet_c --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 3 --backbone tinynet_c --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 4 --backbone tinynet_c --batch_size 8

ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 0 --backbone mobilenetv3_large_100 --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 1 --backbone mobilenetv3_large_100 --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 2 --backbone mobilenetv3_large_100 --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 3 --backbone mobilenetv3_large_100 --batch_size 8
ts --gpus 2 python train.py cfg000_sagittal_t2_spinal_slice_dist_level_seq --sync_batchnorm --benchmark --fold 4 --backbone mobilenetv3_large_100 --batch_size 8

...
cfg.fold = 0 
cfg.dataset = "axial_t2_regression"
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_pngs_3ch/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_axial_t2_regression_kfold.csv"
cfg.inputs = "filepath"
cfg.targets = ["x_rt", "y_rt", "x_lt", "y_lt"]

...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_gt_all_with_augs_kfold.csv"
cfg.inputs = "filepath"
cfg.targets = ["normal_mild_foramen", "moderate_foramen", "severe_foramen", "normal_mild_spinal", "moderate_spinal", "severe_spinal", "normal_mild_subarticular", "moderate_subarticular", "severe_subarticular"]
...
cfg.loss = "SampleWeightedLogLossAll"
cfg.loss_params = {}
...
cfg.metrics = ["CompetitionMetricPlusAUROCMultiAugSigmoidAll"]

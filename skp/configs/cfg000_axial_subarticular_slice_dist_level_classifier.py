...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_axial_subarticular_localizer_clean_with_level.csv"
cfg.inputs = "filepath"
cfg.targets = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1", "l1", "l2", "l3", "l4", "l5", "s1", "rt_subarticular", "lt_subarticular"]
cfg.targets += [f"rt_{lvl}_dist_scaled" for lvl in cfg.targets[:5]]
cfg.targets += [f"lt_{lvl}_dist_scaled" for lvl in cfg.targets[:5]]
cfg.cv2_load_flag = cv2.IMREAD_COLOR
cfg.num_workers = 10
cfg.channel_reverse = True
cfg.pin_memory = True

cfg.loss = "LevelAndDist"
cfg.loss_params = {}

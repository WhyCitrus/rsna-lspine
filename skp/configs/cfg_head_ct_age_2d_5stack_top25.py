...
cfg.fold = 0 
cfg.dataset = "stack_2dc"
cfg.data_dir = "/mnt/stor/datasets/spr-head-ct-age-prediction/"
cfg.annotations_file = cfg.data_dir + "train_slice_5stack_kfold_top25.csv"
cfg.inputs = "filename5"
cfg.targets = ["Age"]
...
], additional_targets={f"image{idx+1}": "image" for idx in range(4)})

cfg.val_transforms = A.Compose([A.Resize(cfg.image_height, cfg.image_width, p=1)], additional_targets={f"image{idx+1}": "image" for idx in range(4)})

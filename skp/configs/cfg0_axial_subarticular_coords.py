...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_predicting_axial_subarticular_coords_v2.csv"
cfg.inputs = "filepath"
cfg.targets = ["lt_subarticular_x", "lt_subarticular_y", "rt_subarticular_x", "rt_subarticular_y"]

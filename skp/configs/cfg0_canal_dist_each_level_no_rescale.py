...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_canal_distance_each_level.csv"
cfg.inputs = "pngfile"
cfg.targets = ["l1_l2_no_rescale", "l2_l3_no_rescale", "l3_l4_no_rescale", "l4_l5_no_rescale", "l5_s1_no_rescale"]

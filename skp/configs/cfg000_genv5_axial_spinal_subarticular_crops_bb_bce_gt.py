...
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_axial_spinal_crops_from_gt_coords_with_augs/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_axial_spinal_and_subarticular_gt_with_augs_kfold.csv"
cfg.inputs = "filepath"
cfg.targets = ["normal_mild_rt_subart", "moderate_rt_subart", "severe_rt_subart", 
               "normal_mild_lt_subart", "moderate_lt_subart", "severe_lt_subart", 
               "normal_mild_spinal", "moderate_spinal", "severe_spinal"]
...
cfg.loss = "SampleWeightedLogLossSpinalSubarticular"
cfg.loss_params = {}
...
cfg.metrics = ["CompetitionMetricPlusAUROCMultiAugSigmoidSpinalSubarticular"]

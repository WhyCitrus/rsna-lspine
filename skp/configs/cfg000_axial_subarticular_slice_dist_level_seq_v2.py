...
cfg.model = "axial_t2_stack_with_var"
...
cfg.fold = 0 
cfg.dataset = "axial_t2_stack_with_var"
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_pngs_3ch/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_axial_subarticular_lcoalizer_clean_with_level_and_spinal_pz.csv"
cfg.inputs = "filepath"
levels = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1"]
cfg.targets = ["l1", "l2", "l3", "l4", "l5", "s1"] + [f"rt_subarticular_{lvl}" for lvl in levels] + [f"lt_subarticular_{lvl}" for lvl in levels]
cfg.targets += [f"rt_{lvl}_dist_scaled" for lvl in levels]
cfg.targets += [f"lt_{lvl}_dist_scaled" for lvl in levels]

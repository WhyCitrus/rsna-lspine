...
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_subarticular_full_slices/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_subarticular_full_slices_kfold.csv"
cfg.inputs = "filepath"
...
cfg.loss = "SampleWeightedLogLossBilat"
cfg.loss_params = {}
...
cfg.metrics = ["AUROCBilat", "CompetitionMetricBilat"]

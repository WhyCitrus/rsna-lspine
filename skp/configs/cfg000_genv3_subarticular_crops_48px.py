...
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_generated_crops_with_augs_dist_coord_seg/subarticular/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_gen_subarticular_crops_with_augs.csv"
cfg.inputs = "filepath"
...
cfg.val_transforms = A.Compose([A.Resize(cfg.image_height, cfg.image_width, p=1), A.CenterCrop(64, 64, p=1)])

...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_subarticular_dist_coord_proba_with_weights.csv"
cfg.inputs = "pngfile"
...
cfg.targets += ["rt_subarticular_coord_x", "rt_subarticular_coord_y", "lt_subarticular_coord_x", "lt_subarticular_coord_y"]
...
cfg.loss = "L1DistCoordBCESubarticular"
cfg.loss_params = {}

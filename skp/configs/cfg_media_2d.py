...
cfg.model = "net_2d"
cfg.backbone = "coatnet_rmlp_2_rw_384.sw_in12k_ft_in1k"
cfg.pretrained = True
...
cfg.annotations_file = "data_media/train_slice_kfold_df.csv"
cfg.inputs = "slice_filename"
cfg.targets = ["slice_label"]

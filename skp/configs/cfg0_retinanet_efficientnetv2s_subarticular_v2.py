...
cfg.model = "retinanet_efficientnetv2s"
cfg.pretrained_backbone = True
cfg.num_classes = 2

cfg.fold = 0 
cfg.dataset = "foramen_bboxes" # can use same dataset as foramen
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_pngs/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_subarticular_bboxes_v2.pkl"
...
cfg.metrics = ["CenterDiffAbsSubarticular"]

...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_subart_distance_each_level_with_subart_coords_and_ignore_imputed_level_agnostic.csv"
cfg.inputs = "pngfile"
levels = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1"]
cfg.targets = [f"rt_{_}_no_rescale" for _ in levels] + [f"lt_{_}_no_rescale" for _ in levels]
cfg.targets += ["rt_subart_coord_x", "rt_subart_coord_y", "lt_subart_coord_x", "lt_subart_coord_y"]
cfg.cv2_load_flag = cv2.IMREAD_COLOR
cfg.num_workers = 10
cfg.pin_memory = True

cfg.loss = "L1LossDistCoordSegSubarticularV4"

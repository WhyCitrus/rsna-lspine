...
cfg.model = "net_2d_grouped_spinal"
...
cfg.fold = 0 
cfg.dataset = "grouped_spinal"
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_crops_gt_with_augs/spinal/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_grouped_spinal_annotations.pkl"
...
cfg.metrics = ["CompetitionMetricGroupedSpinal"]
...
], additional_targets={f"image{idx}": "image" for idx in range(1, 5)}, is_check_shapes=False)

...
cfg.model = "swin_transformer_v2"
cfg.backbone = "swinv2_base_window12to16_192to256"
cfg.pretrained = True
...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_gen_foramen_crops_with_augs.csv"
cfg.inputs = "filepath"

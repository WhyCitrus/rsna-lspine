...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_spinal_dist_coord_proba_sampling_weight.csv"
cfg.inputs = "pngfile"
levels = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1"]
cfg.targets = [f"{_}_no_rescale" for _ in levels] + [f"{_}_proba_score" for _ in levels]
cfg.targets += [f"{_}_spinal_coord_x" for _ in levels] + [f"{_}_spinal_coord_y" for _ in levels]

...
cfg.pretrained = True
#cfg.load_pretrained_backbone = "/home/ian/projects/rsna-lspine/skp/experiments/cfg000_genv5_foramina_crop_classifier/e0d49874/fold0/checkpoints/last.ckpt"
...
cfg.loss = "SampledWeightedCrossEntropyWithValidSlice"
cfg.loss_params = {}
...
cfg.metrics = ["CompetitionMetricPlusAUROCMultiAugSoftmaxValidSlice"]

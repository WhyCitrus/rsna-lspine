...
cfg.fold = 0 
cfg.dataset = "spider_mri_lspine"
cfg.data_dir = "/mnt/stor/datasets/spider-mri-lumbar-spine/pngs/"
cfg.annotations_file = "/mnt/stor/datasets/spider-mri-lumbar-spine/train_seg_png_kfold.csv"
cfg.num_workers = 2
cfg.pin_memory = True

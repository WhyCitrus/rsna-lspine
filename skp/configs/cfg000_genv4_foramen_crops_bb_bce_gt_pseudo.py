...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_gt_foraminal_with_augs_pseudo_kfold.csv"
cfg.inputs = "filepath"
cfg.targets = ["normal_mild", "moderate", "severe", "normal_mild_pseudo", "moderate_pseudo", "severe_pseudo"]
...
cfg.loss = "SampleWeightedLogLossPseudo"
cfg.loss_params = {}
...
cfg.metrics = ["CompetitionMetricPlusAUROCMultiAugSigmoidPseudo"]

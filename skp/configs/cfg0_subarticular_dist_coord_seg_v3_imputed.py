...
cfg.fold = 0 
cfg.dataset = "subarticular_dist_coord_seg"
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_pngs_3ch/"
cfg.seg_dir = "/home/ian/projects/rsna-lspine/data/train_subarticular_segmentation_maps_smaller/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_subart_distance_each_level_with_subart_coords_and_ignore_imputed.csv"
cfg.inputs = "pngfile"
levels = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1"]
cfg.targets = [f"rt_{_}_no_rescale" for _ in levels] + [f"lt_{_}_no_rescale" for _ in levels]
cfg.targets += [f"rt_{_}_subart_coord_x" for _ in levels] + [f"lt_{_}_subart_coord_x" for _ in levels]
cfg.targets += [f"rt_{_}_subart_coord_y" for _ in levels] + [f"lt_{_}_subart_coord_y" for _ in levels]
cfg.cv2_load_flag = cv2.IMREAD_COLOR
cfg.num_workers = 10
cfg.pin_memory = True

cfg.loss = "L1LossDistCoordSegSubarticularV3"

...
cfg.dropout = 0.5
cfg.num_classes = 3
cfg.var_embed_shape = 5
cfg.var_embed_dim = 16

cfg.normalization = "-1_1"
cfg.normalization_params = {"min": 0, "max": 255}

cfg.fold = 0 
cfg.dataset = "simple_2d_sample_weights_with_level"
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_generated_crops_using_detection2/canal/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_gen_det2_spinal_crops_kfold.csv"
cfg.inputs = "filepath"

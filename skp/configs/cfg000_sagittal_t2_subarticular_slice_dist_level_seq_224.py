...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_sag_subarticular_localization_kfold.csv"
cfg.inputs = "filepath"
levels = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1"]
levels = [f"rt_{lvl}" for lvl in levels] + [f"lt_{lvl}" for lvl in levels]

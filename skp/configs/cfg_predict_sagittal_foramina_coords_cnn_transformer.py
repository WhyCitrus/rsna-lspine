...
cfg.model = "net_2d_transformer"
cfg.backbone = "tf_efficientnetv2_s"
cfg.pretrained = True
cfg.load_pretrained_backbone = [
    "experiments/cfg_sagittal_foramina_coords_2d/9d8603c4/fold0/checkpoints/last.ckpt",
    "experiments/cfg_sagittal_foramina_coords_2d/2f8b7427/fold1/checkpoints/last.ckpt",
    "experiments/cfg_sagittal_foramina_coords_2d/13723a33/fold2/checkpoints/last.ckpt",
    "experiments/cfg_sagittal_foramina_coords_2d/663b4154/fold3/checkpoints/last.ckpt",
    "experiments/cfg_sagittal_foramina_coords_2d/f0496eca/fold4/checkpoints/last.ckpt"
]

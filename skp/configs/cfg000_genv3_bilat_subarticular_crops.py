...
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_bilateral_subarticular_crops_with_augs_dist_coord_seg/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_gen_bilateral_subarticular_crops_with_augs.csv"
cfg.inputs = "filepath"
...
cfg.loss = "SampleWeightedCrossEntropyBilat"
cfg.loss_params = {}
...
cfg.metrics = ["CompetitionMetricPlusAUROCMultiAugSigmoidSubarticularBilat"]

...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_identify_axial_subarticular_slice_and_level.csv"
cfg.targets = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1", "l1", "l2", "l3", "l4", "l5", "s1", "rt_subarticular", "lt_subarticular", "rt_x", "rt_y", "lt_x", "lt_y"]
cfg.cv2_load_flag = cv2.IMREAD_COLOR
cfg.num_workers = 10
cfg.channel_reverse = False
cfg.pin_memory = True

cfg.loss = "MaskedBCEWithLogitsSeqPlusCoords"
cfg.loss_params = {}

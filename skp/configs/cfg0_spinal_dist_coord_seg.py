...
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_spinal_distance_each_level_with_coords.csv"
cfg.inputs = "pngfile"
levels = ["l1_l2", "l2_l3", "l3_l4", "l4_l5", "l5_s1"]
cfg.targets = [f"{_}_no_rescale" for _ in levels]
cfg.targets += [f"{_}_foramen_coord_x" for _ in levels]
cfg.targets += [f"{_}_foramen_coord_y" for _ in levels]
cfg.cv2_load_flag = cv2.IMREAD_COLOR
cfg.num_workers = 10
cfg.pin_memory = True

cfg.loss = "L1LossDistCoordSegSpinalV2"

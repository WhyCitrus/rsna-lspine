...
cfg.data_dir = "/home/ian/projects/rsna-lspine/data/train_axial_spinal_subarticular_crops_gt_with_augs/"
cfg.annotations_file = "/home/ian/projects/rsna-lspine/data/train_axial_spinal_subarticular_crops_gt_with_augs_kfold.csv"
cfg.inputs = "filepath"
cfg.targets = ["normal_mild_rt", "moderate_rt", "severe_rt", "normal_mild_lt", "moderate_lt", "severe_lt", "normal_mild", "moderate", "severe"]
